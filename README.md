...
2. Clone this repository and go to `p3_collab-compet/` folder.  If you haven't already, [install pip](https://anaconda.org/anaconda/pip), and finally 
install all project dependencies.
```bash
git clone https://github.com/aamonten/p3_collab-compet.git
cd p3_collab-compet
